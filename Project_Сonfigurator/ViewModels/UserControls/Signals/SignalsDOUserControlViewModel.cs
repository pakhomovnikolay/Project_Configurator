...
namespace Project_Сonfigurator.ViewModels.UserControls.Signals
{
    public class SignalsDOUserControlViewModel : ViewModelUserControl
    {
        ...
        public SignalsDOUserControlViewModel(ISignalService _ISignalService) : this()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public override void SetParams<T>(ObservableCollection<T> _Params) => Params = _Params as ObservableCollection<SignalDO>;
        #endregion
