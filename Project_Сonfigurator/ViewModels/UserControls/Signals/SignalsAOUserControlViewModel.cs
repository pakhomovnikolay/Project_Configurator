...
{
    public class SignalsAOUserControlViewModel : ViewModelUserControl
    {
        #region Конструктор
        ...
        private void OnCmdChangeAddressSignalExecuted(object p)
        {
            ...
            DoSelection = true;
            var NameListSelected = SignalServices.ChangeAddress(Title, TypeAddress.AO, SelectedParam.Signal.Area);
        ...
        /// </summary>
        /// <returns></returns>
        public override void SetParams<T>(ObservableCollection<T> _Params) => Params = _Params as ObservableCollection<SignalAO>;
        #endregion
